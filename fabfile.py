...
env.django = 'aornfoxvalley_django'
# Name of project source directory inside Django "webapp"
env.project = 'aornfoxvalley'
# Name of static "webapp" on WebFaction
env.assets = 'aornfoxvalley_assets'
# Name of virtualenv (that uses virtualenvwrapper) on WebFaction
env.virtualenv = 'aornfoxvalley'

# Database type ('mysql', 'postgresql')
env.db_type = 'postgresql'
# Database name/username
env.db_name = os.environ['AORN_DB_NAME']
# Database password
env.db_pass = os.environ['AORN_DB_PASS']

# SSH URL of Git repo (must be Git)
env.repo = 'git@github.com:richardcornish/aornfoxvalley.git'
# URL of "Website"
env.website_url = 'http://aorn.richardcornish.com'
