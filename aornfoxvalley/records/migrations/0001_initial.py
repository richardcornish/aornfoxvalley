...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('records_category', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50)),
        ))
        db.send_create_signal('records', ['Category'])
        ...
        db.create_table('records_record', (
            ...
            ('document', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('remove_document', self.gf('django.db.models.fields.BooleanField')(default=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('records_category')
    ...
    models = {
        ...
        'records.record': {
            'Meta': {'ordering': "['-published']", 'object_name': 'Record'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['records.Category']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'document': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
