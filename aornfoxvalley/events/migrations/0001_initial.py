...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('events_place', (
            ...
            ('state', self.gf('django.db.models.fields.CharField')(default='IL', max_length=255, blank=True)),
            ...
            ('country', self.gf('django.db.models.fields.CharField')(default='United States', max_length=255, blank=True)),
        ))
        ...
        db.create_table('events_event', (
            ...
            ('speaker', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['speakers.Speaker'], null=True, blank=True)),
    ...
    models = {
        ...
        'events.event': {
            ...
            'speaker': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['speakers.Speaker']", 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'topic': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'})
        },
        'events.place': {
            'Meta': {'ordering': "['title', 'address_2']", 'object_name': 'Place'},
            ...
            'country': ('django.db.models.fields.CharField', [], {'default': "'United States'", 'max_length': '255', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            'remove_image': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50'}),
            'state': ('django.db.models.fields.CharField', [], {'default': "'IL'", 'max_length': '255', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'zip_code': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'})
        },
        'speakers.speaker': {
            'Meta': {'ordering': "['last_name', 'first_name']", 'object_name': 'Speaker'},
