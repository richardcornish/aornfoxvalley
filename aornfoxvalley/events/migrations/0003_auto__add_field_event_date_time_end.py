...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.date_time_end'
        db.add_column('events_event', 'date_time_end',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.date_time_end'
        db.delete_column('events_event', 'date_time_end')
    ...
    models = {
        ...
        'events.event': {
            ...
            'date_time_end': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'events.place': {
            'Meta': {'ordering': "['state', 'city', 'title']", 'object_name': 'Place'},
