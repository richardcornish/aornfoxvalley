...
ADMINS = (
    # ('Webmaster', 'webmaster@aornfoxvalley.org'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ['AORNFOXVALLEY_DB_NAME'],
        'USER': os.environ['AORNFOXVALLEY_DB_USER'],
        'PASSWORD': os.environ['AORNFOXVALLEY_DB_PASS'],
        'HOST': '',
        'PORT': '',
    }
}
...
STATICFILES_DIRS = (
    ...
    '/home/richardcornish/webapps/aornfoxvalley_django/aornfoxvalley/aornfoxvalley/static/',
)
...
SECRET_KEY = os.environ['AORNFOXVALLEY_SECRET_KEY']
...
MIDDLEWARE_CLASSES = (
    'django.middleware.cache.UpdateCacheMiddleware', # first for cache
    ...
    'django.middleware.cache.FetchFromCacheMiddleware', # last for cache
)
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    '/home/richardcornish/webapps/aornfoxvalley_django/aornfoxvalley/aornfoxvalley/templates/',
)
...
CONTACT_EMAIL = os.environ['AORNFOXVALLEY_EMAIL_HOST_USER']
